...
async function handleSubmit(e){
    ...
    const sendMessage = {id: stamp + '-' + MD5(useText || useFile[0]).toString(), stamp, replied: false, replies: false, iden: isAuth, file: useFile ? useFile : null, text: useText, category: document.getElementById('category').value || null, comment: document.getElementById('comment').value || null}
